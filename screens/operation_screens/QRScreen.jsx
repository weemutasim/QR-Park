...
const QRScreen = ({ navigation }) => {
  ...
  return (
    <QRCodeScanner
        ...
        topContent = {
          <View>
            <TouchableOpacity onPress={() => setFlash(flash === RNCamera.Constants.FlashMode.off ? RNCamera.Constants.FlashMode.torch : RNCamera.Constants.FlashMode.off)}>
              {
        ...
        bottomContent = {
          <View style={styles.container}>
            <Text style = {{color: '#000000', padding: 20, fontSize: 20, margin: 10, color: '#000000', }}>{data}</Text>
